## Disclaimer 
On Thursday, July 13th, we submitted the Datadog PySigma backend to the maintainers of Sigma and the `main` branch is broken. In the meantime, the `pysigma-datadog-backend-local` branch can be run locally. 
