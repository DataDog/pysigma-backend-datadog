...
from sigma.processing.transformations import ChangeLogsourceTransformation, FieldMappingTransformation, RuleFailureTransformation
from sigma.processing.conditions import LogsourceCondition, RuleProcessingCondition, RuleProcessingItemAppliedCondition
