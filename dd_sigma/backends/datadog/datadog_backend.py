...
class DatadogBackend(TextQueryBackend):
    ...
    compare_operators: ClassVar[Dict[SigmaCompareExpression.CompareOperators, str]] = {
        # Datadog Security Rules do not support the less than
    ...
    field_not_exists_expression: ClassVar[
        str
        # Not sure that NOT `-` operator with a space works
    ...
    def finalize_query_siem_rule(
        ...
        siem_rule = {
            ...
            # We will have to use another field since this one is generated by Datadog
            "ruleId": str(rule.id),
            ...
            "cases": [
                ...
                # You could build the message field of the pySigma rule with the description,
                # the reference, and the false positives fields.
            ],
        }
        return siem_rule
