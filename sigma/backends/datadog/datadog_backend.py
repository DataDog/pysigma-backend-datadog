...
import sys
sys.path.append("backends/datadog")

from datadog_pipeline import DatadogPipeline

# from sigma.pipelines.datadog import DatadogPipeline
...
class DatadogBackend(TextQueryBackend):
    ...
    formats: Dict[str, str] = {
        ...
        "siem_rule": "Datadog query syntax as DD Cloud SIEM Rules in JSON Format",
    }
    requires_pipeline : bool = True
    backend_processing_pipeline : ClassVar[ProcessingPipeline] = DatadogPipeline()
